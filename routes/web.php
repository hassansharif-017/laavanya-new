...
Route::get('/load_home_page_ajax', [App\Http\Controllers\Frontend\HomeFrontendController::class, 'load_home_page_ajax'])->name('frontend.load_home_page_ajax');
Route::get('/aboutus', [App\Http\Controllers\Frontend\HomeFrontendController::class, 'aboutus'])->name('frontend.aboutus');

//offer
Route::get('/frontend/offerad', [App\Http\Controllers\Frontend\HomeFrontendController::class, 'offerad'])->name('offerad');

//new arrival
Route::get('/frontend/newarrival', [App\Http\Controllers\Frontend\HomeFrontendController::class, 'newarrival'])->name('newarrival');
...
Route::any('/frontend/update-quantity/{id}/{qty}', [App\Http\Controllers\Frontend\CartController::class, 'updateQuantity'])->name('frontend.updateQuantity');
...
Route::post('/frontend/checkemail', [App\Http\Controllers\Frontend\CheckoutFrontController::class, 'checkemail'])->name('frontend.checkemail');
...
Route::prefix('backend')->group(function(){
	...
	Route::get('/shiprocket/{id}', [App\Http\Controllers\Backend\OrdersController::class, 'shiprocket'])->name('backend.shiprocket')->middleware(['auth','is_admin']);
