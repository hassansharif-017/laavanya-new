...
function onPaginationDataLoad(page) {
	$.ajax({
		url: base_url + "/backend/getTestimonialsTableData?page=" + page,
...
function onRefreshData() {
	$.ajax({
		url: base_url + "/backend/getTestimonialsTableData",
		success: function (data) {
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onSearch() {
	...
	$.ajax({
		url: base_url + "/backend/getTestimonialsTableData?search=" + search,
		success: function (data) {
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onConfirmWhenAddEdit() {
	...
	$.ajax({
		type: 'POST',
		url: base_url + '/backend/saveTestimonialsData',
...
function onLoadEditData() {
	...
	$.ajax({
		type: 'POST',
		url: base_url + '/backend/getTestimonialsById',
		data: 'id=' + RecordId,
		success: function (response) {
			var data = response;
			...
			$("#f_thumbnail_thumbnail").val(data.image);
...
function onConfirmDelete() {
	...
	$.ajax({
		type: 'POST',
		url: base_url + '/backend/deleteTestimonials',
		data: 'id=' + RecordId,
		success: function (response) {
			var msgType = response.msgType;
			var msg = response.msg;
...
function onConfirmBulkAction() {
	...
	$.ajax({
		type: 'POST',
		url: base_url + '/backend/bulkActionTestimonials',
