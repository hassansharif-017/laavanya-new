<script async src="https://apigoswirl.com/short_video/v3/laavanya/swirl-short-videos-v3.9.min.js"></script>
<!-- Footer Top Section -->
@if($gtext['is_subscribe_footer'] == 1)
<section class="footer-top" style="background-color: #F3ECDA;">
	<div class="container">
		<div class="row">
...
<section class="section offer-section" style="background-color: #F3ECDA; padding-top:30px;">

<div class="container">
  <div class="row ">
	<div class="col-lg-3 col-3 " style=" display: grid; justify-content: center;">
	  <img class="" src="https://laavanya-gracefullyyou.in/public/frontend/images/fi11.png" alt=""> <br>
	 <p>Free Shipping over Rs. 999</p> 
	</div>
	<div class="col-lg-3 col-3 " style=" display: grid; justify-content: center;">
	  <img src="https://laavanya-gracefullyyou.in/public/frontend/images/fi21.png" alt=""> <br>
	  <p style="text-align: center;">Safe Payment</p>
	</div>
	<div class="col-lg-3 col-3 " style=" display: grid; justify-content: center;">
	  <img src="https://laavanya-gracefullyyou.in/public/frontend/images/fi31.png" alt=""> <br>
	  <p>On time Delivery</p>
	</div>
	<div class="col-lg-3 col-3 " style=" display: grid; justify-content: center;">
	  <img src="https://laavanya-gracefullyyou.in/public/frontend/images/fi41.png" alt=""> <br>
	  <p>Made in INDIA</p>
	</div>
  </div>
</div>
...
<footer class="footer-section" style="background-color: #F3ECDA;">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4">
					...
					<div class="footer-widget-card">
						<div class="footer-widget mb25">
							<h3 class="widget-title">Visit Our Store</h3>
							<iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3507.566760941204!2d77.08504606546927!3d28.462473582485313!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d18db30d373a5%3A0xe83ecbb67aa7d3cc!2sLaavanya%20-%20Gracefully%20You!5e0!3m2!1sen!2sin!4v1672510930091!5m2!1sen!2sin"
              width="100%" height="250" style="border:0;" allowfullscreen="" loading="lazy"
              referrerpolicy="no-referrer-when-downgrade"></iframe>
			  <div class="text-dark">B-121 & 150, Supermart-1, DLF Phase IV, Gurugram, Haryana 122002</div><br>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					...
					<div class="copy-right" style="color:black">
