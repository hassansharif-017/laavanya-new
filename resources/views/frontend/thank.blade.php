			...
			<div class="row">
				<div class="col-sm-12 col-md-10 offset-md-2 col-lg-6 offset-lg-3 col-xl-6 offset-xl-3 col-xxl-6 offset-xxl-3">
					<div class="register thank text-center w-100">
						...
						<h3>{{ __('Your order is successful.') }}</h3>
						<p>{{ __('Thank you for joining Laavanya Family.') }}</p>
						@if(Session::has('order_arr'))
                            <p>Your Order ID is: <strong>{{ implode(",", Session::get('order_arr')) }}</strong></p>
                        @endif
