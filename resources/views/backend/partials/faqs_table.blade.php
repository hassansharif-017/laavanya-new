    ...
    <table class="table table-borderless table-theme" style="width:100%;">
        <thead>
            <tr>
                ...
                <th class="text-left" style="width:15%">Question</th>
                <th class="text-center" style="width:30%">Answer</th>
                <th class="text-center" style="width:5%">Status</th>
                <th class="text-left" style="width:5%">Display Order</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-left">{{ $row->display_order }}</td>
