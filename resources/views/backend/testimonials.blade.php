			...
			<div class="col-lg-12">
				<div class="card">
					...
					<div id="list-panel" class="card-body">
						...
						<div id="tp_datalist">
							@include('backend.partials.testimonials_table')
						</div>
					</div>
					<!--/Data grid/-->
					...
					<div id="form-panel" class="card-body dnone">
						<form novalidate="" data-validate="parsley" id="DataEntry_formId">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label for="address">Description<span class="red">*</span></label>
										<textarea name="description" id="description" class="form-control" rows="3" data-required="true"></textarea>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										<label for="f_thumbnail_thumbnail">{{ __('Profile Photo') }}<span class="red">*</span></label>
										...
										<em>Recommended image size width: 250px and height: 250px.</em>
