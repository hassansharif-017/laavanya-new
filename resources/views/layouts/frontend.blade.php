...
<head>
	...
	<script type="text/javascript">
		...
		})(window, document, "clarity", "script", "ikjueoq97f");
	</script>
	<!-- Meta Pixel Code -->
<script>
	!function(f,b,e,v,n,t,s)
	...
	s.parentNode.insertBefore(t,s)}(window, document,'script',
	'https://connect.facebook.net/en_US/fbevents.js');
	fbq('init', '669467628451190');
	fbq('track', 'PageView');
	</script>
	<noscript><img height="1" width="1" style="display:none"
	src="https://www.facebook.com/tr?id=669467628451190&ev=PageView&noscript=1"
	/></noscript>
	<!-- End Meta Pixel Code -->
	<style type="text/css">
	:root {
	  ...
	  --arabic-font-family: 'Montserrat', sans-serif;
	  --font-size-100: 14px;
	  --font-size-200: 16px;
	  --font-size-300: 18px;
	  --font-size-400: 20px;
